...
const multipleUpdatesRequired = [
  ...
  '/Users/someone/git/prm-deductions-repo-to-gp/check_for_updates.js',
  '/Users/someone/git/prm-deductions-repo-to-gp:uuid@3.4.0:uuid@7.0.2:uuid@7.0.2',
  '/Users/someone/git/prm-deductions-repo-to-gp:ppc@3.4.0:ppc@5.0.2:ppc@7.0.2'
];
...
describe('parse_dependency_updates.js', () => {
  ...
  describe('isUpdate', () => {
    it('should return true if the string contains an update', () => {
      expect(
        isUpdate('/Users/someone/git/prm-deductions-repo-to-gp:uuid@3.4.0:uuid@7.0.2:uuid@7.0.2')
      ).toBe(true);
    });
  ...
  describe('fromString', () => {
    it('should convert the update string to an object', () => {
      expect(
        fromString('/Users/someone/git/prm-deductions-repo-to-gp:uuid@3.4.0:uuid@7.0.2:uuid@7.0.2')
      ).toEqual({
        package: 'uuid',
        wantedVersion: '3.4.0',
