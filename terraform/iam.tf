...
data "aws_iam_policy_document" "ssm_policy_doc" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ssm:${var.region}:${local.account_id}:parameter/repo/${var.environment}/user-input/api-keys/gp2gp-adaptor/repo-to-gp",
      "arn:aws:ssm:${var.region}:${local.account_id}:parameter/repo/${var.environment}/user-input/api-keys/ehr-repo/repo-to-gp",
      ...
      "arn:aws:ssm:${var.region}:${local.account_id}:parameter/repo/${var.environment}/output/prm-deductions-gp2gp-adaptor/service-url",
